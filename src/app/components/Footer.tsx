...
export default function Footer() {
    return (
        <footer className="w-full bg-[#15803d] text-white box-border mt-auto font-sans">
            {/* Main Footer Area */}
            <div className="flex flex-col md:flex-row justify-end items-center gap-7 px-[8%] py-[30px] md:text-right text-center">
                ...
                <ul className="list-none p-0 m-0 flex flex-col gap-3">
                    ...
                    <li className="flex flex-col md:flex-row items-center gap-2 md:gap-[15px] text-[0.95rem] font-bold">
                        ...
                        <span className="leading-[1.3]">(02) 8352-2000 (ext. 2111)</span>
                    </li>
                    ...
                    <li className="flex flex-col md:flex-row items-center gap-2 md:gap-[15px] text-[0.95rem] font-bold">
                        ...
                        <span className="leading-[1.3]">support@valpaws.ph</span>
                    </li>
            ...
            {/* Copyright Bar */}
            <div className="bg-[#15803d] border-t-4 border-white py-[15px] text-center text-[0.9rem] font-normal tracking-[0.5px]">
                &copy; 2026 ValPaws. All Rights Reserved.
            </div>
        </footer>
    );
}